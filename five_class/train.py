...
full_text = list(train['Phrase'].values) + list(test['Phrase'].values) # start from here
...
def build_model1(lr=0.0, lr_d=0.0, units=0, spatial_dr=0.0, kernel_size1=3, kernel_size2=2, dense_units=128, dr=0.1, conv_size=32):
    ...
    history = model.fit(X_train, y_ohe, batch_size = 128, epochs = 50, validation_split=0.1, 
